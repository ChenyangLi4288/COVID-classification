...
#setwd("C:/Users/hn2345/Dropbox/project-sars2classification/edata/")
...
# metdat[metdat$case.id==298,]
# min(metdat$sample.id[metdat$case.id==298])
# 
# 
# metdat$sample.id2 = as.numeric(gsub("SS","",metdat$sample.id))
# metdat[metdat$case.id==298,]
# min(metdat$sample.id2[metdat$case.id==298])
...
# tpm[,metadata_patient$diagnosis == "Severe"]
...
saveRDS(tpm_negative_mean, file = "tpm_negative_mean.rds")
saveRDS(tpm_negative_sd, file = "tpm_negative_sd.rds")
...
saveRDS(gc3, file = "gc3.rds")
saveRDS(severe_negative, file = "severe_negative.rds")
saveRDS(mild_negative, file = "mild_negative.rds")
saveRDS(severe_mild, file = "severe_mild.rds")
